...
var (
	...
	disableSettingsMetrics = kingpin.Flag("disable-settings-metrics", "Do not include gs_settings metrics.").Default("false").Envar("PG_EXPORTER_DISABLE_SETTINGS_METRICS").Bool()
