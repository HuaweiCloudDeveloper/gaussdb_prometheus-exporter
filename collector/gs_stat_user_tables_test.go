...
func TestPGStatUserTablesCollector(t *testing.T) {
	...
	expected := []MetricResult{
		...
		{labels: labelMap{"datname": "gaussdb", "schemaname": "public", "relname": "a_table"}, metricType: dto.MetricType_GAUGE, value: 1685923200},
		{labels: labelMap{"datname": "gaussdb", "schemaname": "public", "relname": "a_table"}, metricType: dto.MetricType_COUNTER, value: 11},
		{labels: labelMap{"datname": "gaussdb", "schemaname": "public", "relname": "a_table"}, metricType: dto.MetricType_COUNTER, value: 12},
		{labels: labelMap{"datname": "gaussdb", "schemaname": "public", "relname": "a_table"}, metricType: dto.MetricType_COUNTER, value: 13},
		{labels: labelMap{"datname": "gaussdb", "schemaname": "public", "relname": "a_table"}, metricType: dto.MetricType_COUNTER, value: 14},
		{labels: labelMap{"datname": "gaussdb", "schemaname": "public", "relname": "a_table"}, metricType: dto.MetricType_GAUGE, value: 15},
		{labels: labelMap{"datname": "gaussdb", "schemaname": "public", "relname": "a_table"}, metricType: dto.MetricType_GAUGE, value: 16},
	}
